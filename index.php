...
<body>
          ...
          <div class="card bg-dark plantilla">
            <div class="card-body cardUni">
              <div class="cardFirtPart">
                ...
                <button class="btn btn-lg btn-outline-light " style="color: black;"
                  id="nombre<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                  data-bs-target="#modalnombre<?= $carta['idMounstro'] ?>">
                  <?php echo  $carta['nombre'] ?></button>

                <button class="btn btn-lg btn-outline-light cardAtribute " style="color: black;"
                  id="atributo<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                  data-bs-target="#modalAtributo<?= $carta['idMounstro'] ?>">
                  <img src="./img/<?php echo $carta['Atributo'] ?>.png" alt="<?php $carta['Atributo'] ?>"></button>

              </div>
              <div class="botonesModifi">

                <button class="btn btn-success modDanger" id="habilitar<?php echo $carta['idMounstro'] ?>"
                  onclick="habilitarBotones(<?php echo $carta['idMounstro'] ?>)"><img class="ajusteImg"
                    src="./img/modif.png" alt="modificar"></button>
                <button class="btn btn-sucess modDanger" style="display: none;"
                  id="deshabilitar<?php echo $carta['idMounstro'] ?>"
                  onclick="deshabilitarBotones(<?php echo $carta['idMounstro'] ?>)"><img class="ajusteImg"
                    src="./img/completado.png" alt="modificar"></button>
                <button class="btn btn-danger modDanger" id="borrar<?php echo $carta['idMounstro'] ?>"
                  data-bs-toggle="modal" data-bs-target="#modalConfirDelete<?= $carta['idMounstro'] ?>"><img
                    class="ajusteImg" src="./img/eliminar.png" alt="eliminarr"></button>

              </div>
              <div class="cardLevel">
                <button class="btn btn-lg btn-outline-light " style="color: black;"
                  id="nivel<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                  data-bs-target="#modalNivel<?= $carta['idMounstro'] ?>">
                  <?php echo "Nivel " . $carta['nivel'] ?></button>

              </div>
              <div><button disabled class="cardButImg" id="img<?php echo $carta['idMounstro'] ?>">
                  <img src="./<?php echo $carta['img'] ?>" class="cardImg" alt="<?php echo  $carta['nombre'] ?>"
                    disabled data-bs-toggle="modal" data-bs-target="#modalimg<?= $carta['idMounstro'] ?>"></button>
              </div>

              <button class="btn btn-lg btn-outline-light cardType" style="color: black;"
                id="tipo<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                data-bs-target="#modalTipos<?= $carta['idMounstro'] ?>">
                <strong> <?php echo "[" . $carta['Tipos'] . "]" ?></strong></button>

              <button class="btn btn-lg btn-outline-light cardDescription" style="color: black;"
                id="descripcion<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                data-bs-target="#modalDescripcion<?= $carta['idMounstro'] ?>">
                <?php echo $carta['descripcion'] ?></button>

              <div class="cardPuntationContainer">
                <div class="cardPuntation">
                  <button class="btn btn-lg btn-outline-light textPuntation" style="color: black;"
                    id="atkBut<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                    data-bs-target="#modalAtaque<?= $carta['idMounstro'] ?>">
                    <b><?php echo $carta['ataque'] ?></button></b>

                  <button class="btn btn-lg btn-outline-light textPuntation space" style="color: black;"
                    id="defBut<?php echo $carta['idMounstro'] ?>" disabled data-bs-toggle="modal"
                    data-bs-target="#modalDefensa<?= $carta['idMounstro'] ?>">
  ...
  <div class="modal fade" id="modalConfirDelete<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalConfirDelete" aria-hidden="true">
  ...
  <div class="modal fade" id="modalnombre<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalnombre<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <div class="modal fade" id="modalDescripcion<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalDescripcion<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel2">Actual :
  ...
  <div class="modal fade" id="modalNivel<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalNivel<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel2">Actual :
  ...
  <div class="modal fade" id="modalAtaque<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalAtaque<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel2">Actual :
  ...
  <div class="modal fade" id="modalDefensa<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalDefensa<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel2">Actual :
        ...
        <div class="modal-body">
          ...
          <form action="./php_controllers/cardController.php" method="POST" enctype="multipart/form-data">
            ...
            <select class="form-select" aria-label="Default select example" name='newAtributo'>
              ...
              <option required value="<?= $atributo['idAtributo'] ?>"
                <?php echo (isset($carta['atributo']) && $carta['atributo'] == $atributo['idAtributo']) ? 'selected' : '';  ?>>
  ...
  <div class="modal fade" id="modalimg<?= $carta['idMounstro'] ?>" tabindex="-1"
    aria-labelledby="modalimg<?= $carta['idMounstro'] ?>" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel2">Actual :
