      ...
      <div class="card formAjust">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" required class="form-control" id="exampleFormControlInput1" name='nombre'
              placeholder="Kuriboh" maxlength="22" value="<?php echo $carta['nombre'];  ?>">
          </div>
          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Descripcion</label>
            <textarea required class="form-control" id="exampleFormControlTextarea1" rows="3" name='descripcion'
              maxlength="100"
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="exampleFormControlInput1" name='ataque' placeholder="300"
              required min="0" max="9999" value="<?php echo $carta['ataque']; ?>">
          </div>
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="exampleFormControlInput1" name='defensa' placeholder="200"
              min="0" max="9999" value="<?php echo $carta['defensa'];  ?>">
          </div>
          ...
          <div class="mb-3">
            <select class="form-select" aria-label="Default select example" name='atributo'>
              ...
              <option required value="<?= $atributo['idAtributo'] ?>"
                <?php echo ($carta['atributo'] == $atributo['idAtributo']) ? 'selected' : '';  ?>>
          ...
          <div class="form-check">
            <?php
        $tipos_seleccionados = isset($carta['tipos_seleccionados']) ? $carta['tipos_seleccionados'] : [];
        $checked = (in_array($tipo['idTipo'], $tipos_seleccionados)) ? 'checked' : '';
        ?>
            <input type="checkbox" class="btn-check" id="check<?= $tipo['idTipo'] ?>" autocomplete="off" name="tipos[]"
              value="<?= $tipo['idTipo'] ?>" <?= $checked ?>>
          ...
          <div class="mb-3">
            ...
            <input type="number" name="nivel" id="exampleFormControlInput1" min="0" max="12" class="form-control"
              required value="<?php echo $carta['nivel'];  ?>"><br><br>
          </div>
